...
/// category is premium and offers a "Request access" action via WhatsApp.
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              '“${category.title}” is locked. Request access from the admin to '
              'unlock its study materials.',
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: const Text('Request access on WhatsApp'),

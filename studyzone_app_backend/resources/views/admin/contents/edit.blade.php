        ...
        <form action="{{ route('admin.contents.update', $content->id) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-4" id="content-type-container">
                    <label class="content-type-option relative flex items-center p-4 border-2 rounded-lg cursor-pointer transition-colors {{ old('content_type', $content->content_type) == 'pdf' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-blue-300' }}">
                        <input 
                            type="radio" 
                            name="content_type" 
                            value="pdf" 
                            {{ old('content_type', $content->content_type) == 'pdf' ? 'checked' : '' }}
                    ...
                    <label class="content-type-option relative flex items-center p-4 border-2 rounded-lg cursor-pointer transition-colors {{ old('content_type', $content->content_type) == 'audio' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-blue-300' }}">
                        <input 
                            type="radio" 
                            name="content_type" 
                            value="audio" 
                            {{ old('content_type', $content->content_type) == 'audio' ? 'checked' : '' }}
                            class="sr-only content-type-radio"
                            required
                        >
                        <div class="flex items-center">
            ...
            <div>
                ...
                <input 
                    ...
                    id="backblaze_url" 
                    name="backblaze_url" 
                    value="{{ old('backblaze_url', $content->backblaze_url) }}"
                    required
                    placeholder="https://..."
